...
pages = ["Cruzamento Cartola", "Comparação de jogadores","Confrontos","Ranking SofaScore"]#,"Cruzamento SofaScore"]
tags = ["Awesome", "Social"]
st.set_page_config(page_title='Breno Mestre',layout="wide")
page = st.sidebar.radio("Navegação", options=pages)

clubes = pd.read_excel('Clubes.xlsx')
...
if page == "Cruzamento Cartola":
  ...
  data = pd.read_excel("completo_mercado.xlsx")
  ...
  data = pd.read_excel("completo_sofascore.xlsx")
  ...
  data = pd.read_excel(f"sofascore_bruto/sofascore_bruto{rodada}.xlsx")
  ...
  ""
  ""
  col0, col1, col2, col3 = st.beta_columns((.85, .1, 1, .9))
  with col1:
    ""
